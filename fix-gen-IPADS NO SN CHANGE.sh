...
curl -s -k "http://gsmadjaa.000webhostapp.com/bypass/activatorFix.php?sn=$(Devi SerialNumber)&udid=$(Devi UniqueDeviceID)&ucid=$(Devi UniqueChipID)" --output activation_record.plist
echo ''
